...
class Transformer(nn.Module):
    def __init__(self, embedding_dim, 
        ...
        self.region_size = [[24, 24, 32], [24, 24, 32], [40, 40, 32], [40, 40, 40], [48, 40, 32], [40, 40, 40], 
                            [40, 40, 48], [40, 48, 48], [48, 48, 40], [48, 48, 40], [48, 40, 48], [48, 40, 48], 
                            [40, 48, 40], [40, 48, 40], [48, 48, 40], [40, 48, 40], [40, 48, 40], [48, 48, 40], [48, 48, 40], 
                            [40, 48, 48], [48, 40, 48], [40, 48, 48], [40, 48, 40]]
        ...
        encoder_layer_heart = nn.TransformerEncoderLayer(embedding_dim, num_head, dim_feedforward, dropout, activation)
        self.transformer_heart = nn.TransformerEncoder(encoder_layer_heart, num_layers)
